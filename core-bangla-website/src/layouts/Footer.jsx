...
const FooterContainer1 = styled(HBox)`
    padding-left: 120px;
    padding-right: 120px;
...
const FooterContainer2Text = styled(P4)`
    color: ${colors.grey};
`
...
const Footer = () => {
    return (
        <>
            ...
            <FooterContainer2>
                <VBox align='center'>
                    <FooterContainer2Text className='mt-4'>নিয়ম ও শর্তাবলী  |  গোপনীয়তা নীতিমালা  |  ফেরত নীতিমালা</FooterContainer2Text>
                    <FooterContainer2Text className='mb-4'>© নেক্সটজেন ডিজিটেক লিমিটেড.</FooterContainer2Text>
                </VBox>
            </FooterContainer2>
        </>
    );
